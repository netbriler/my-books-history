    ...
    return (
        <PublicLayout title={'Privacy Policy'}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to My Books History, accessible from <a
                        href="https://my-books-history.ml" rel="external nofollow noopener"
                        target="_blank">https://my-books-history.ml</a></p>
                </li>
                <li>
